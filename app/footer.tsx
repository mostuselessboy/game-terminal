    ...
    <footer style={{background: 'linear-gradient(0deg, #35780a45, #000 20%)', borderImage: 'linear-gradient(45deg, #66b734, #000, #3a7516, #e3d1ff63, #000) 40', color: '#cecece', borderTop: '1px solid #f5f5f500'}} className="font-clash-display w-full bg-gradient-to-b  from-[#141414]  to-black text-white ">
      <div className="container mx-auto px-4 flex flex-col items-center">
        ...
        <div className="flex gap-6 mb-6">
          <Link href="https://www.linkedin.com/company/gameterminalio/" className="text-white hover:text-[#8EFA48] transition-colors">
          ...
          <Link href="https://x.com/gameterminal_" className="text-white hover:text-[#8EFA48] transition-colors">
          ...
          {/* TELEGRAM */}
          <Link href="https://t.me/GameTerminalchat" className="text-white hover:text-[#8EFA48] transition-colors -translate-x-1">
