...
export default function TextFillEffectSolutions() {
      ...
      <section>
        <div className="container" ref={containerRef}>
          <div className="space-y-2">
            <h2 className="text-xl  md:text-3xl font-[300] font-clash-display leading-tight animate-fill green-fill text-center">
             See What Problems We
              <br />
              Solved Together!
            </h2>
          </div>
